...
const ohmyzsh = {
  ...
  async handle() {
    ...
    try {
      ...
      // Install Oh My Zsh
      await runner.run('sh -c "$(curl -fsSL https://raw.github.com/ohmyzsh/ohmyzsh/master/tools/install.sh)"');

      spinner.succeed(`Zsh and Oh My Zsh installed ${formatElapsedTime(spinner)}`);
